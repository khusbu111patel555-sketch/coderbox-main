...
// const AboutHero = () => {
//   return (
//     <section className="relative pt-96 pb-20 bg-gradient-to-br from-[#003F7D] via-[#005B8F] to-[#003F7D] overflow-hidden">
//       <div className="absolute inset-0 opacity-20">
//         <div className="absolute top-0 left-0 w-full h-full bg-[url('https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1920')] bg-cover bg-center"></div>
//       </div>
...
//         >
//           {/* Badge */}
//           <span className="sec-badge inline-block mb-4">
//             About Us
//           </span>

//           {/* Heading */}
//           <h1 className="sec-hero-heading text-white">
//             Your Journey of Digital Transformation Begins Here! <br />
...
//           {/* Paragraph */}
//           <p className="sec-p text-[#A7E8FF]/80 max-w-2xl mx-auto mt-6">
//             A group of creative thinkers gathered under one roof collaboratively striving forward with a motto to take business developments to its pinnacle.
//           </p>
//         </motion.div>
//       </div>
...
//             className="relative flex justify-center"
//           >
//             <div className="relative w-full max-w-md aspect-[4/5] bg-[#003F7D] rounded-[40px] overflow-hidden shadow-2xl shadow-[#005B8F]/20 border border-white/10">
...
//             transition={{ duration: 1, type: "spring", stiffness: 50, damping: 15, delay: 0.2 }}
//           >
//             <span className="sec-badge inline-block mb-2">
//               About us
//             </span>
...
//             className="text-center mb-8"
//           >
//             <h2 className="sec-h2 text-white">
//               This is us now
//               <span className="sec-p text-[#A7E8FF]/80 mt-2 block">
//                 A capable engine with multiple milestones
//               </span>
//             </h2>
//           </motion.div>
...
//                   )}
//                 </div>
//                 <p className="sec-p text-[#A7E8FF]/80 mt-2 tracking-wide">
//                   {stat.label}
//                 </p>
//               </motion.div>
//             ))}
...
//                     className="absolute inset-0 rounded-full"
//                     style={{
//                       background: 'conic-gradient(from 0deg, #01ADF0, #00C6FB, #03B4F6, #01ADF0)',
//                       padding: '3px'
//                     }}
//                     animate={{ rotate: 360 }}
//                     transition={{ duration: 8, repeat: Infinity, ease: "linear" }}
...
//                 <h3 className="sec-h3 text-gray-900 mb-4 group-hover:text-[#008FD1] transition-colors duration-300">
//                   {item.title}
//                 </h3>

//                 <div className="w-16 h-1 bg-gradient-to-r from-[#00C6FB] to-[#01ADF0] rounded-full mx-auto mb-4"></div>

//                 <p className="sec-p text-gray-600 leading-relaxed max-w-sm mx-auto">
//                   {item.content}
//                 </p>
//               </motion.div>
//             ))}
...
//   return (
//     <section className="py-10 sm:py-12 bg-[#003F7D] relative overflow-hidden">
//       <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-[#01ADF0]/10 rounded-full blur-[120px] pointer-events-none"></div>
...
//         >
//           <h2 className="sec-h2 text-white">
//             Our Global <span className="text-[#00C6FB]">Presence</span>
//           </h2>
//           <p className="sec-p text-[#A7E8FF]/60 mt-3 tracking-wider uppercase">
//             Time is Presence - Find us at our global locations
//           </p>
//         </motion.div>
...
//             >
//               <div className="relative">
//                 <div className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 bg-white rounded-full flex items-center justify-center shadow-lg shadow-[#01ADF0]/50 group-hover:scale-125 transition-transform duration-300 border-2 border-[#00C6FB]">
//                   <span className="text-sm sm:text-lg md:text-xl">{loc.flag}</span>
//                 </div>
//                 <div className="absolute inset-0 rounded-full border-2 border-[#00C6FB] animate-ping opacity-20"></div>
//               </div>
//               <div className="mt-1 md:mt-2 text-center">
//                 <p className="text-white font-semibold text-[8px] sm:text-[10px] md:text-xs bg-black/60 backdrop-blur-sm px-1.5 md:px-2 py-0.5 rounded border border-white/10 whitespace-nowrap">
//                   {loc.country}
...
//             >
//               <div className="relative">
//                 <div className="w-6 h-6 sm:w-8 sm:h-8 bg-white rounded-full flex items-center justify-center shadow-lg shadow-[#01ADF0]/50 group-hover:scale-125 transition-transform duration-300 border-2 border-[#00C6FB]">
//                   <span className="text-sm sm:text-lg">🇮🇳</span>
//                 </div>
//                 <div className="absolute inset-0 rounded-full border-2 border-[#00C6FB] animate-ping opacity-20"></div>
//               </div>
...
//             Our Journey
//           </span>
//           <h2 className="sec-h2 text-gray-900">
...
//   return (
//     <section className="relative py-10 sm:py-12 md:py-14 bg-[#005B8F] border-t border-white/10 overflow-hidden">
...
//             animate={{ opacity: 1, scale: 1 }}
//             transition={{ duration: 0.5 }}
//             className="sec-badge inline-flex items-center gap-2 mb-2"
//           >
//             <Quote className="h-3 w-3 text-[#00C6FB]" />
//             Testimonials
//           </motion.div>
          
//           <motion.h2 
//             className="sec-h2 text-white mt-1 leading-tight"
//             initial={{ opacity: 0, y: 15 }}
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ duration: 0.5, delay: 0.1 }}
//           >
...
//           <motion.p 
//             className="sec-p text-[#A7E8FF]/80 mt-1 max-w-2xl mx-auto"
//             initial={{ opacity: 0, y: 15 }}
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ duration: 0.5, delay: 0.15 }}
//           >
...
//                       <div className="relative mb-3 mx-auto w-16 h-16 sm:w-20 sm:h-20">
//                         <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full overflow-hidden ring-2 ring-[#01ADF0]/20 group-hover:ring-[#01ADF0]/50 shadow-xl shadow-[#01ADF0]/10 transition-all duration-300">
//                           <img 
//                             src={testi.image} 
//                             alt={testi.name}
//                             className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
...
//                       <h3 className="sec-h3 text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-[#00C6FB] group-hover:to-[#01ADF0] transition-all duration-300">
//                         {testi.name}
//                       </h3>
//                       <p className="sec-p text-[#01ADF0] mt-0.5">{testi.role}</p>
...
//                       <div className="w-6 h-0.5 bg-gradient-to-r from-[#00C6FB] to-[#01ADF0] mx-auto my-2 rounded-full opacity-50 group-hover:opacity-100 transition-opacity" />

//                       <p className="sec-p text-[#E6F8FF]/80 leading-relaxed italic">
//                         "{testi.text}"
//                       </p>
//                     </div>
//                   </motion.div>
...
// // ============================================
// // 7. CONTACT US SECTION (Contact form with Supabase - No Map/Tabs)
// // ============================================
...
// const AboutUs = () => {
//   return (
//     <div className="min-h-screen bg-[#003F7D] overflow-x-hidden font-sans">
//       <AboutHero />
//       <AboutContent />
//       <VisionMission />
//       <GlobalPresence />
...
// ============================================
// 1. HERO SECTION (SCC Infotech Exact Size)
// ============================================
const AboutHero = () => {
  return (
    // 👇 min-h-screen + flex centering — exact viewport height, content centered
    <section 
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* ===== LARGE MUTED PURPLE CIRCLES ===== */}
        <motion.div
          className="absolute top-[12%] left-[3%] w-[260px] h-[260px] rounded-full"
          style={{ 
            background: 'radial-gradient(circle, rgba(88, 28, 135, 0.45) 0%, rgba(88, 28, 135, 0.1) 55%, transparent 75%)',
            filter: 'blur(2px)',
          }}
          animate={{ 
            x: [0, 25, 0, -15, 0],
        ...
        <motion.div
          ...
          style={{ 
            background: 'radial-gradient(circle, rgba(76, 29, 149, 0.5) 0%, rgba(76, 29, 149, 0.1) 55%, transparent 75%)',
            filter: 'blur(2px)',
          }}
          animate={{ 
            x: [0, 35, 0, -25, 0],
        ...
        <motion.div
          ...
          style={{ 
            background: 'radial-gradient(circle, rgba(59, 7, 100, 0.5) 0%, rgba(59, 7, 100, 0.1) 55%, transparent 75%)',
            filter: 'blur(2px)',
          }}
          animate={{ 
            x: [0, -20, 0, 25, 0],
        ...
        {/* ===== WIREFRAME 3D STAR / OCTAHEDRON (TOP RIGHT) ===== */}
        <svg 
        ...
        >
          ...
          >
            ...
            <line x1="250" y1="40" x2="420" y2="250" stroke="url(#wireGrad)" strokeWidth="0.5" opacity="0.5" />
            <line x1="250" y1="40" x2="80" y2="250" stroke="url(#wireGrad)" strokeWidth="0.5" opacity="0.5" />
            <line x1="250" y1="460" x2="420" y2="250" stroke="url(#wireGrad)" strokeWidth="0.5" opacity="0.5" />
            <line x1="250" y1="460" x2="80" y2="250" stroke="url(#wireGrad)" strokeWidth="0.5" opacity="0.5" />
            <polygon points="250,160 340,250 250,340 160,250" stroke="url(#wireGrad)" strokeWidth="0.7" fill="none" opacity="0.5" />
          </motion.g>
        </svg>

        {/* ===== WIREFRAME CUBE (MIDDLE RIGHT) ===== */}
        <svg 
          className="absolute top-[42%] right-[22%] w-[220px] h-[220px] opacity-[0.55]" 
          viewBox="0 0 200 200" 
          fill="none"
          style={{ filter: 'drop-shadow(0 0 8px rgba(96, 165, 250, 0.4))' }}
        >
          <motion.g
            animate={{ rotate: [0, 5, 0, -5, 0], y: [0, 8, 0, -8, 0] }}
            transition={{ duration: 12, repeat: Infinity, ease: 'easeInOut' }}
          >
            <rect x="40" y="40" width="120" height="120" stroke="#60A5FA" strokeWidth="0.8" fill="none" opacity="0.7" />
            <rect x="20" y="20" width="120" height="120" stroke="#A855F7" strokeWidth="0.8" fill="none" opacity="0.6" />
            <line x1="40" y1="40" x2="20" y2="20" stroke="#60A5FA" strokeWidth="0.6" opacity="0.5" />
            <line x1="160" y1="40" x2="140" y2="20" stroke="#60A5FA" strokeWidth="0.6" opacity="0.5" />
            <line x1="40" y1="160" x2="20" y2="140" stroke="#60A5FA" strokeWidth="0.6" opacity="0.5" />
            <line x1="160" y1="160" x2="140" y2="140" stroke="#60A5FA" strokeWidth="0.6" opacity="0.5" />
            <line x1="40" y1="80" x2="160" y2="80" stroke="#60A5FA" strokeWidth="0.4" opacity="0.4" />
            <line x1="40" y1="120" x2="160" y2="120" stroke="#60A5FA" strokeWidth="0.4" opacity="0.4" />
            <line x1="80" y1="40" x2="80" y2="160" stroke="#60A5FA" strokeWidth="0.4" opacity="0.4" />
            <line x1="120" y1="40" x2="120" y2="160" stroke="#60A5FA" strokeWidth="0.4" opacity="0.4" />
          </motion.g>
        </svg>

        {/* ===== ROTATED SQUARE - LIGHT BLUE (TOP RIGHT) ===== */}
        <motion.div
        ...
        {/* ===== ROTATED SQUARE - PURPLE (BOTTOM RIGHT) ===== */}
        <motion.div
          className="absolute bottom-[20%] right-[18%] w-[240px] h-[240px] rounded-2xl"
          style={{ 
            background: 'linear-gradient(135deg, rgba(168, 85, 247, 0.35) 0%, rgba(88, 28, 135, 0.1) 100%)',
      ...
      <div className="relative py-10 sm:py-12 bg-gradient-to-b from-[#003F7D] via-[#005B8F] to-[#003F7D] overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-8 lg:px-16 relative z-10">
          ...
          >
            ...
            >
              This is us now
              <span className="sec-p text-[#A7E8FF]/80 mt-1 block">
                A capable engine with multiple milestones
              </span>
            </motion.h2>
          </motion.div>
    ...
    <section className="py-10 sm:py-12 bg-[#003F7D] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-8 lg:px-16 relative z-10">
        ...
        >
          ...
          <motion.p 
            className="sec-p text-[#A7E8FF]/60 mt-1 tracking-wider uppercase"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.2 }}
          >
      ...
      <div className="container relative z-10 mx-auto px-6">
        <div className="mb-10 text-center">
          <motion.div
            ...
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.5 }}
            className="sec-badge inline-block mb-2"
          >
            Contact Us
          </motion.div>
          <motion.h2 
