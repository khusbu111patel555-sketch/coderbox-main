...
// //   const latestBlogs = [
// //     { id: 1, title: "Local SEO Strategies to Grow Restaurant Customers in Pune", date: "August 11, 2026", category: "Digital Marketing", image: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=600&h=400&fit=crop", readTime: "5 min read", author: "Preeti Rai", link: "/blog/local-seo-strategies" },
// //     { id: 2, title: "The 5 Big Shifts Making Healthcare Marketing Autonomous in 2026", date: "August 9, 2026", category: "Digital Marketing", image: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=600&h=400&fit=crop", readTime: "7 min read", author: "Rahul Sharma", link: "/blog/healthcare-marketing-shifts" },
// //     { id: 3, title: "Pharma Digital Transformation in 2026: Key Trends", date: "August 7, 2026", category: "Digital Marketing", image: "https://images.unsplash.com/photo-1532938911079-1b06ac7ceec7?w=600&h=400&fit=crop", readTime: "4 min read", author: "Ananya Patel", link: "/blog/pharma-digital-transformation" },
// //     { id: 4, title: "The AI Playbook Every Healthcare Marketer Needs in 2026", date: "August 5, 2026", category: "Digital Marketing", image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=600&h=400&fit=crop", readTime: "6 min read", author: "Vikram Singh", link: "/blog/ai-playbook-healthcare" },
// //     { id: 5, title: "Local SEO Strategies to Grow Restaurant Customers in Pune", date: "August 11, 2026", category: "Digital Marketing", image: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=600&h=400&fit=crop", readTime: "5 min read", author: "Preeti Rai", link: "/blog/local-seo-strategies" },
// //     { id: 6, title: "The 5 Big Shifts Making Healthcare Marketing Autonomous in 2026", date: "August 9, 2026", category: "Digital Marketing", image: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=600&h=400&fit=crop", readTime: "7 min read", author: "Rahul Sharma", link: "/blog/healthcare-marketing-shifts" }
// //   ];
...
// //         {/* Header */}
// //         <div className="text-center mb-2 sm:mb-3">
// //           <span className="sec-badge inline-block">
// //             Our Blog
// //           </span>
// //           <h2 className="sec-h2 sec-text-dark mt-1 leading-tight">
// //             Latest <span className="bg-gradient-to-r from-[#01adf0] to-purple-500 bg-clip-text text-transparent">News & Blogs</span>
// //           </h2>
// //           <p className="sec-p sec-text-dark-soft mt-0.5 max-w-2xl mx-auto">
// //             Stay updated with latest trends
// //           </p>
// //         </div>
...
// //                         {/* Image */}
// //                         <div className="relative h-[45%] sm:h-[50%] overflow-hidden">
// //                           <img src={blog.image} alt={blog.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" loading="lazy" />
// //                           <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
...
// //                         {/* Content */}
// //                         <div className="p-1.5 sm:p-2">
// //                           <div className="flex items-center sec-p text-gray-400 mb-0.5">
// //                             <Calendar className="h-1.5 w-1.5 mr-0.5" />
// //                             <span className="truncate">{blog.date}</span>
// //                           </div>
                          
// //                           {/* Title (h3) */}
// //                           <h3 className={`sec-h3 mb-0.5 line-clamp-2 transition-colors ${
// //                             isActive ? 'text-[#01adf0]' : 'sec-text-dark group-hover:text-[#01adf0]'
// //                           }`}>
// //                             {blog.title}
// //                           </h3>
...
// //                             <a
// //                               href={blog.link}
// //                               className="inline-flex items-center text-[#01adf0] font-medium sec-p gap-0.5 hover:text-[#01adf0]/70 transition-colors"
// //                               onClick={(e) => e.stopPropagation()}
// //                             >
// //                               Read
// //                               <ArrowRight className="h-1.5 w-1.5 sec-btn-arrow" />
// //                             </a>
// //                           )}
// //                         </div>
// //                       </div>
...
// //           >
// //             View All
// //             <ArrowRight className="h-2 w-2 sm:h-2.5 sm:w-2.5 sec-btn-arrow" />
// //           </a>
// //         </div>
// //       </div>
// //     </section>
...
//       type: 'teal-text',
//       category: 'Insights',
//       title: 'Software development methodologies: types, selection criteria & stats',
//       description: 'Learn how different software development methodologies impact software delivery and what to consider when choosing a suitable method for your project.',
...
//       type: 'black-text',
//       category: 'Insights',
//       title: 'Software development risks: types & mitigation strategies',
//       description: 'Learn the common risks that can hamper successful completion of software engineering projects and the strategies companies can use to minimize them.',
...
//       type: 'teal-text',
//       category: 'Case study',
//       title: 'Pharmaceutical data analytics suite for a US multinational',
//       description: "Read about Itransition's 10+ years long cooperation with a US-based multinational to create their flagship pharmaceutical data analytics products.",
...
//       description: 'Learn how Itransition developed iOS and Android applications for a European bond trader with over $1 billion raised in funds for their clients.',
...
//       type: 'teal-text',
//       category: 'Case study',
//       title: 'Order and inventory management solution for fashion business',
//       description: 'Learn how we developed an order and inventory management system on top of Odoo and achieved product management cost reduction and efficiency improvement.',
...
//           hoverTitle: 'group-hover:text-teal-200',
//         };
//       case 'black-text':
//         return {
//           bg: 'bg-[#1a1a1a]', // Dark Black
//           category: 'text-gray-400',
//           title: 'text-white',
//           desc: 'text-gray-300/80',
//           hoverTitle: 'group-hover:text-gray-300',
//         };
//       case 'white-text':
//       default:
//         return {
...
//           title: 'text-gray-900',
//           desc: 'text-gray-600',
//           hoverTitle: 'group-hover:text-[#01adf0]',
//         };
//     }
//   };
...
//             Insights & <span className="text-[#01adf0]">Case Studies</span>
//           </h2>
//         </motion.div>
...
//             const styles = getTextStyles(item.type);
//             const isImageFirst = item.order === 'image-first';
...
//                 className={`group relative flex flex-col sm:flex-row h-full min-h-[320px] sm:min-h-[360px] overflow-hidden cursor-pointer ${
...
//                 {/* ===== TEXT SIDE ===== */}
//                 <div className={`relative w-full sm:w-1/2 p-6 sm:p-8 flex flex-col justify-center ${styles.bg} transition-all duration-500`}>
//                   {/* Category */}
...
//                   {/* Title */}
//                   <h3 className={`text-lg sm:text-xl md:text-2xl font-bold leading-tight mb-3 ${styles.title} ${styles.hoverTitle} transition-colors duration-300`}>
//                     {item.title}
//                   </h3>
...
//                     <span className={`text-xs font-semibold uppercase tracking-wider ${item.type === 'white-text' ? 'text-[#01adf0]' : 'text-white/80'}`}>
//                       Read more
//                     </span>
//                     <ArrowRight className={`h-4 w-4 transition-transform duration-300 group-hover:translate-x-2 ${item.type === 'white-text' ? 'text-[#01adf0]' : 'text-white/80'}`} />
//                   </div>
//                 </div>
