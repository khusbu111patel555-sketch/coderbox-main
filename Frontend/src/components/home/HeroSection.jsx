...
//                 <motion.p 
//                   variants={textVariants}
//                   className="text-sm sm:text-base md:text-lg lg:text-lg xl:text-xl max-w-2xl leading-relaxed font-light text-white"
//                 >
//                   {currentVideo.description}
//                 </motion.p>
...
//                     <div className="min-w-0 flex-1">
//                       {/* Card Title — WHITE */}
//                       <h3 className="font-semibold text-xs sm:text-sm lg:text-base xl:text-lg text-white">
//                         {card.title}
//                       </h3>
//                       {/* Card Description — WHITE (soft) */}
//                       <p className="text-[10px] sm:text-xs lg:text-sm xl:text-base truncate text-white/80">
//                         {card.description}
//                       </p>
//                     </div>
//                   </div>
...
//                   className="flex flex-wrap gap-3 sm:gap-4 pt-1 sm:pt-2"
//                 >
//                   {/* Primary Button — Using consistent sec-btn */}
//                   <motion.a
//                     href="/contact"
//                     whileTap={{ scale: 0.95 }}
//                     className="sec-btn"
...
//                     </div>
//                     <div className="min-w-0 flex-1">
//                       {/* Card Title — Ab FONT-BOLD hai */}
//                       <h3 className="font-bold text-xs sm:text-sm lg:text-base xl:text-lg text-white">
//                         {card.title}
//                       </h3>
//                       {/* Card Description — WHITE (soft) */}
//                       <p className="text-[10px] sm:text-xs lg:text-sm xl:text-base truncate text-white/80">
...
//                     </div>
//                     <div className="min-w-0 flex-1">
//                       {/* 👇 Card Title — Ab BLUE hai (#00C6FB) */}
//                       <h3 className="font-bold text-xs sm:text-sm lg:text-base xl:text-lg text-[#00C6FB]">
//                         {card.title}
//                       </h3>
//                       {/* 👇 Card Description — Ab BLUE hai (#00C6FB with 80% opacity) */}
//                       <p className="text-[10px] sm:text-xs lg:text-sm xl:text-base truncate text-[#00C6FB]/80">
//                         {card.description}
//                       </p>
//                     </div>
//                   </div>
...
import React, { useState, useEffect } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { ArrowRight, Play } from 'lucide-react'; // 👈 ChevronLeft, ChevronRight hata diye
...
const HeroSection = () => {
  ...
  // ===== NAVIGATION FUNCTIONS =====
  // 👈 goToPrevious aur goToNext functions hata diye, kyunki arrow buttons nahi hain
