...
// //   const testimonials = [
// //     { quote: "Coderbox transformed our digital presence completely. Their AI solutions increased our efficiency by 300%.", author: "John Doe", company: "TechCorp Inc.", rating: 5, role: "CEO", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop&crop=face" },
// //     { quote: "The team's expertise in digital marketing helped us achieve unprecedented growth in just 6 months.", author: "Jane Smith", company: "GrowthHub Ltd.", rating: 5, role: "Marketing Director", image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&h=200&fit=crop&crop=face" },
// //     { quote: "Delivered our complex web portal 2 weeks ahead of deadline. The UX design quality is top notch!", author: "Robert Miller", company: "Nexus Systems", rating: 5, role: "CTO", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&h=200&fit=crop&crop=face" },
// //     { quote: "Outstanding SEO & Web Development services. Our organic search leads spiked by 180% within 90 days.", author: "Sophia Williams", company: "Aura Creative", rating: 5, role: "Founder", image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=200&h=200&fit=crop&crop=face" },
// //     { quote: "Their team handled our cloud migration seamlessly. ZERO downtime experienced during the entire transition.", author: "David Lee", company: "FinTech Global", rating: 5, role: "VP of Engineering", image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop&crop=face" },
// //     { quote: "Remarkable custom software development! Built a scalable mobile app that hit 100k downloads in 1 month.", author: "Emily Davis", company: "AppScale Studio", rating: 5, role: "Product Manager", image: "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=200&h=200&fit=crop&crop=face" },
// //     { quote: "Very professional workflow, high responsiveness, and unbeatable design system aesthetics. Highly recommended!", author: "Michael Brown", company: "Elevate Brand", rating: 5, role: "Managing Director", image: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=200&h=200&fit=crop&crop=face" },
// //     { quote: "They revitalized our outdated e-commerce store into a high-converting automated sales machine.", author: "Olivia Taylor", company: "Luxe Retail", rating: 5, role: "Head of E-Commerce", image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=200&h=200&fit=crop&crop=face" },
// //     { quote: "The best tech collaboration partner we've worked with. Their proactive communication is unmatched.", author: "Alex Johnson", company: "Venture Wave", rating: 5, role: "Chief Innovation Officer", image: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=200&h=200&fit=crop&crop=face" }
// //   ];
...
// //           </motion.span>
// //           <motion.h2 
// //             className="sec-h2 sec-text-dark mt-1.5 leading-tight"
// //             initial={{ opacity: 0, y: 20 }}
// //             animate={{ opacity: 1, y: 0 }}
// //             transition={{ duration: 0.6, delay: 0.15 }}
// //           >
...
// //                   {/* Quote (p) */}
// //                   <p className="sec-p sec-text-dark-soft leading-relaxed mb-3 line-clamp-4">
// //                     "{testimonial.quote}"
// //                   </p>
// //                 </div>
...
// //                     <div>
// //                       {/* Author (h3) */}
// //                       <h3 className="sec-h3 sec-text-dark mb-0">{testimonial.author}</h3>
// //                       {/* Role (p) */}
// //                       <p className="sec-p sec-text-dark-soft mb-0">{testimonial.role}</p>
// //                       {/* Company (p) */}
// //                       <p className="sec-p sec-text-muted mb-0">{testimonial.company}</p>
// //                     </div>
// //                   </div>
...
// //               href="/portfolio"
// //               whileTap={{ scale: 0.95 }}
// //               className="sec-btn !bg-white !text-gray-700 border border-gray-200 hover:!border-[#01adf0]/50 hover:!bg-white !shadow-none hover:!shadow-md"
// //             >
// //               <Briefcase className="h-2.5 w-2.5 sm:h-3 sm:w-3" />
// //               See Our Portfolio
// //             </motion.a>
...
// //                       >
// //                         {/* Value (h2) */}
// //                         <p className={`sec-h2 ${textColor} mb-0`}>
// //                           {card.value}
// //                         </p>
// //                         {/* Label (h3) */}
// //                         <h3 className="sec-h3 sec-text-dark-soft mt-0.5 mb-0">
// //                           {card.label}
// //                         </h3>
// //                       </div>
// //                     );
...
//   // ===== REAL CLIENT TESTIMONIALS (From Document) =====
//   const testimonials = [
//     {
//       quote: "CoderoBox understood our vision and translated it into a website that truly reflects the essence of ShomiHealings. The entire process was thoughtful, creative, and professional. Our digital presence now feels as strong as the work we do.",
//       author: "ShomiHealings",
...
//     },
//     {
//       quote: "CoderoBox transformed the way we communicate on social media. From creative content to consistent strategy, they helped Matangi build a much stronger and more engaging digital presence. Their understanding of branding and audience is impressive.",
//       author: "Matangi",
...
//     },
//     {
//       quote: "We needed more than just a website — we needed a digital platform that could actually support business growth. CoderBox brought both website development and lead generation together into one effective strategy. The difference has been remarkable.",
//       author: "MEDAGREE",
//       role: "LEAD GENERATION & WEBSITE DEVELOPMENT",
//       company: "",
//       rating: 5,
...
//     },
//     {
//       quote: "CoderBox helped us turn our online presence into a genuine business-growth channel. The website looks great, but more importantly, the strategy behind it is designed to attract and convert the right customers. Their team has been proactive and result-focused throughout.",
//       author: "Ciora Cafe",
//       role: "LEAD GENERATION & WEBSITE DEVELOPMENT",
//       company: "",
//       rating: 5,
...
//     },
//     {
//       quote: "In healthcare, communication needs to be sensitive, credible, and engaging. CoderBox understood that balance beautifully. They helped us communicate our expertise online with content that feels professional, approachable, and meaningful.",
...
//     },
//     {
//       quote: "CoderBox showed us how AI can move beyond being a buzzword and become a practical part of our business. Their automation approach has helped streamline processes and reduce repetitive work while making our operations smarter and more efficient.",
//       author: "LEXEDGE",
//       role: "AI AUTOMATION",
//       company: "",
//       rating: 5,
...
//   return (
//     <section className="relative py-12 sm:py-16 md:py-20 bg-[#f5f5f5] overflow-hidden">
      
//       {/* ===== BACKGROUND DECORATION ===== */}
//       <div className="absolute inset-0 pointer-events-none">
//         {/* Large Quote Icon (Top Right) */}
//         <div className="absolute top-16 right-8 sm:right-16 opacity-[0.04]">
//           <Quote className="w-32 h-32 sm:w-48 sm:h-48 text-gray-900 fill-current" />
//         </div>
...
//         {/* Corner Text */}
//         <div className="absolute top-20 right-4 sm:right-10 text-right hidden md:block">
//           <p className="text-[10px] tracking-widest text-gray-400 font-medium leading-tight">
//             REAL PEOPLE
//           </p>
//           <p className="text-[10px] tracking-widest text-gray-400 font-medium leading-tight">
//             REAL GROWTH
...
//         >
//           <motion.span 
//             className="sec-badge inline-block mb-4"
//             whileHover={{ scale: 1.05 }}
//           >
//             Testimonials
//           </motion.span>
          
//           <h2 className="sec-h2 sec-text-dark mb-3">
//             What Our{' '}
...
//           <button
//             onClick={handlePrev}
//             className="absolute left-0 sm:left-2 lg:left-4 top-1/2 -translate-y-1/2 z-30 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white shadow-lg hover:shadow-2xl border border-gray-100 hover:border-[#01adf0] flex items-center justify-center transition-all duration-300 group"
//           >
//             <ChevronLeft className="h-5 w-5 text-gray-600 group-hover:text-[#01adf0] transition-colors" />
//           </button>
          
//           <button
//             onClick={handleNext}
//             className="absolute right-0 sm:right-2 lg:right-4 top-1/2 -translate-y-1/2 z-30 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white shadow-lg hover:shadow-2xl border border-gray-100 hover:border-[#01adf0] flex items-center justify-center transition-all duration-300 group"
//           >
//             <ChevronRight className="h-5 w-5 text-gray-600 group-hover:text-[#01adf0] transition-colors" />
//           </button>

//           {/* Cards Container */}
//           <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 items-center px-8 sm:px-16 lg:px-20">
...
//                 return (
//                   <motion.div
//                     key={`${currentIndex}-${testimonial.author}-${idx}`}
...
//                         : 'border border-gray-100 shadow-md hidden md:block'
//                       }
//                     `}
//                   >
//                     {/* Quote Icon */}
//                     <div className="mb-4">
//                       <Quote className={`h-8 w-8 ${isCenter ? 'text-[#01adf0]/40' : 'text-gray-200'} fill-current`} />
//                     </div>
...
//                     {/* Quote Text */}
//                     <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-6 line-clamp-5">
//                       "{testimonial.quote}"
//                     </p>
...
//                     {/* Author Info */}
//                     <div className="flex items-center gap-3">
//                       <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full overflow-hidden border-2 border-[#01adf0]/20 flex-shrink-0">
//                         <img 
//                           src={testimonial.image} 
//                           alt={testimonial.author}
//                           className="w-full h-full object-cover"
...
//                           {testimonial.author}
//                         </h3>
//                         <p className="text-[10px] sm:text-xs text-gray-500 uppercase tracking-wider font-medium truncate">
//                           {testimonial.role}
//                         </p>
//                       </div>
...
//                           <span className="text-[9px] sm:text-[10px] text-green-700 font-semibold whitespace-nowrap">
//                             Verified Client
//                           </span>
//                         </div>
//                       )}
...
//         >
//           <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-4 max-w-3xl mx-auto">
//             {[
...
//                 </p>
//                 {/* Small underline */}
//                 <div className="w-12 h-0.5 bg-gray-200 mx-auto mt-2"></div>
//               </div>
//             ))}
//           </div>
//         </motion.div>
...
//   return (
//     // ✅ SECTION PADDING KAM KI (py-6 sm:py-8 md:py-10)
//     <section className="relative py-6 sm:py-8 md:py-10 bg-[#f5f5f5] overflow-hidden">
      
//       {/* ===== BACKGROUND DECORATION ===== */}
//       <div className="absolute inset-0 pointer-events-none">
//         {/* Large Quote Icon (Top Right) */}
//         <div className="absolute top-8 right-8 sm:right-16 opacity-[0.04]">
//           <Quote className="w-24 h-24 sm:w-32 sm:h-32 text-gray-900 fill-current" />
//         </div>
...
//   return (
//     // ✅ SECTION BACKGROUND — Image jaisa clean subtle gradient
//     <section className="relative py-6 sm:py-8 md:py-10 overflow-hidden bg-gradient-to-br from-[#f8f9fc] via-[#f5f6fa] to-[#f0f2f8]">

//       {/* ===== BACKGROUND DECORATION (Image jaisa, NO GRID) ===== */}
//       <div className="absolute inset-0 pointer-events-none overflow-hidden">

//         {/* Top-Left Diagonal Lines (Image jaisa) */}
...
//         {/* Corner Text (REAL PEOPLE / REAL GROWTH) */}
//         <div className="absolute top-10 right-4 sm:right-10 text-right hidden md:block">
...
//                 <motion.div
//                   key={`${currentIndex}-${idx}`}
//                   initial={{ opacity: 0, scale: isCenter ? 0.9 : 0.95 }}
//                   animate={{
...
//                     transition-all duration-500 ease-out
//                     ${isCenter
//                       ? 'border-2 border-[#008df1]/40 shadow-2xl shadow-[#008df1]/20 md:scale-105 z-20'
//                       : 'border border-gray-100 shadow-md hidden md:block opacity-80'
//                     }
//                   `}
//                 >
...
//   // ===== REAL CLIENT TESTIMONIALS (Images ki jagah Emoji daale gaye hain) =====
//   const testimonials = [
//     { 
//       quote: "CoderoBox understood our vision and translated it into a website that truly reflects the essence of ShomiHealings. The entire process was thoughtful, creative, and professional. Our digital presence now feels as strong as the work we do.", 
//       author: "ShomiHealings", 
...
//                     {/* 👇 YAHAN IMAGE KI JAGAH EMOJI LAGA DIYA HAI 👇 */}
//                     <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-full border-2 border-[#008df1]/20 flex-shrink-0 flex items-center justify-center bg-[#008df1]/5 text-xl sm:text-2xl">
//                       {testimonial.emoji}
//                     </div>
...
const TestimonialsSection = () => {
  ...
  return (
    ...
    <section className="relative py-6 sm:py-8 md:py-10 lg:py-12 overflow-hidden bg-gradient-to-br from-[#f8f9fc] via-[#f5f6fa] to-[#f0f2f8]">
      ...
      <div className="container mx-auto px-4 sm:px-8 lg:px-16 relative z-10 max-w-7xl">
        ...
        >
          ...
          {/* Heading - Gradient text ke saath */}
          <motion.h2
            ...
            {getVisibleTestimonials().map((testimonial, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="sec-p text-gray-700 mb-4 line-clamp-4">
                    "{testimonial.quote}"
                  </p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="sec-h3 text-gray-900 truncate">{testimonial.author}</h3>
                      <p className="text-[9px] sm:text-[10px] text-gray-500 uppercase tracking-wider font-medium truncate">
                        {testimonial.role}
                      </p>
                    </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-4 max-w-3xl mx-auto">
            {[
              ...
              <div
                ...
                className={`text-center ${idx < 2 ? 'sm:border-r sm:border-gray-200' : ''}`}
              >
                {/* Value - sec-h2 ke size ke saath match */}
                <motion.p
                  className="sec-h2 font-bold mb-1"
                  style={{ color: stat.color }}
                  whileHover={{ scale: 1.05 }}
                >
                  {stat.value}
                </motion.p>
                {/* Label - sec-p ke size ke saath match */}
                <p className="sec-p text-gray-600 font-medium">
                  {stat.label}
                </p>
                <div className="w-10 h-0.5 bg-gray-200 mx-auto mt-1.5"></div>
              </div>
