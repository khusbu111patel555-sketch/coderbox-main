...
// // //       <div className="relative container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 py-8 z-10">
        
// // //         {/* ====== MAIN FOOTER GRID ====== */}
// // //         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 py-4">
          
// // //           {/* Column 1 - CODERBOX WITH LOGO - LOGO BADA AUR BORDER-RADIUS HATAYA */}
// // //           <motion.div 
// // //             initial={{ opacity: 0, y: 30 }}
// // //             whileInView={{ opacity: 1, y: 0 }}
// // //             transition={{ duration: 0.6 }}
...
// // //                 src="https://static.ambitionbox.com/assets/v2/images/rs:fit:200:200:false:false/aHR0cHM6Ly9tZWRpYS5uYXVrcmkuY29tL21lZGlhL2FiY29tcGxvZ28vY29kZXJib3gtb3JpZ2luYWwuanBn.webp"
// // //                 alt="CoderBox Logo"
// // //                 className="w-16 h-16 object-contain" // SIZE BADA - 16x16 (pehle 12x12 tha) AUR BORDER-RADIUS HATAYA
// // //                 whileHover={{ rotate: 10, scale: 1.1 }}
// // //                 onError={(e) => {
// // //                   e.target.onerror = null;
// // //                   e.target.src = 'https://via.placeholder.com/64/2563eb/ffffff?text=CB';
// // //                 }}
// // //               />
// // //             </motion.div>
...
// // //           {/* Column 4 - CONTACT US - REGISTERED OFFICE KO BOLD AUR ACCHA KAR DIYA */}
// // //           <motion.div 
// // //             initial={{ opacity: 0, y: 30 }}
// // //             whileInView={{ opacity: 1, y: 0 }}
// // //             transition={{ duration: 0.6, delay: 0.3 }}
...
// // //               <span className="text-blue-400 font-bold text-xs block mb-2 flex items-center gap-2">
...
// // //                 <motion.div whileHover={{ x: 5 }} className="text-sm text-gray-300 flex items-center gap-2">
// // //                   <Phone size={14} className="text-blue-400 flex-shrink-0" />
// // //                   <span>{registeredOffice.phone}</span>
// // //                 </motion.div>
// // //                 <motion.div whileHover={{ x: 5 }} className="text-sm text-gray-300 flex items-center gap-2">
...
// // //                 whileHover={{ scale: 1.15, y: -5 }}
// // //                 whileTap={{ scale: 0.95 }}
// // //                 className="w-9 h-9 sm:w-10 sm:h-10 bg-white/5 backdrop-blur-sm rounded-full flex items-center justify-center text-white transition-all duration-300 hover:shadow-lg border border-white/10 hover:border-transparent"
// // //               >
// // //                 <social.icon />
// // //               </motion.a>
// // //             ))}
...
// // //       {/* ===== CINEMATIC BACKGROUND EFFECTS - SMALLER ===== */}
// // //       <div className="absolute inset-0">
// // //         <div 
// // //           className="absolute inset-0 opacity-10"
// // //           style={{
...
// // //         />
// // //         <motion.div 
// // //           className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250px] h-[250px] rounded-full bg-pink-600/10 blur-3xl"
// // //           animate={{ scale: [1, 1.3, 0.7, 1], opacity: [0.2, 0.5, 0.2] }}
// // //           transition={{ duration: 15, repeat: Infinity, ease: "easeInOut" }}
// // //         />
...
// // //       {/* ===== GLOWING TOP LINE ===== */}
// // //       <div className="relative z-10 h-0.5 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 shadow-lg shadow-purple-500/50"></div>

// // //       <div className="relative container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 py-4 z-10">
...
// // //                 onError={(e) => {
// // //                   e.target.onerror = null;
// // //                   e.target.src = 'https://via.placeholder.com/48/2563eb/ffffff?text=CB';
// // //                 }}
// // //               />
// // //             </motion.div>
...
// // //               <span className="text-blue-400 font-bold text-[10px] block mb-1 flex items-center gap-1.5">
...
// // //                 <motion.div whileHover={{ x: 5 }} className="text-xs text-gray-300 flex items-center gap-1.5">
...
// // //         <div className="grid grid-cols-1 md:grid-cols-2 gap-3 py-3 border-t border-white/10">
// // //           {/* Newsletter */}
// // //           <motion.div
// // //             initial={{ opacity: 0, y: 20 }}
// // //             whileInView={{ opacity: 1, y: 0 }}
...
// // //                 type="email" 
// // //                 placeholder="Email Address*" 
// // //                 className="flex-1 bg-transparent px-3 py-1.5 text-xs text-white placeholder-gray-500 outline-none"
// // //               />
// // //               <motion.button 
// // //                 whileHover={{ scale: 1.05 }}
// // //                 whileTap={{ scale: 0.95 }}
// // //                 className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white p-1.5 rounded-full mx-1 transition-all duration-200 shadow-lg shadow-blue-500/30"
// // //               >
// // //                 <Send size={14} />
// // //               </motion.button>
// // //             </div>
...
// // //               className="w-8 h-8 sm:w-9 sm:h-9 bg-white/5 backdrop-blur-sm rounded-full flex items-center justify-center text-white transition-all duration-300 border border-white/10 hover:bg-[#1877f2] hover:border-[#1877f2] hover:text-white shadow-lg hover:shadow-[#1877f2]/30"
// // //             >
// // //               <FacebookIcon />
// // //             </motion.a>
...
// // //               href="#"
// // //               whileHover={{ scale: 1.2, y: -3 }}
// // //               className="w-8 h-8 sm:w-9 sm:h-9 bg-white/5 backdrop-blur-sm rounded-full flex items-center justify-center text-white transition-all duration-300 border border-white/10 hover:bg-[#000000] hover:border-[#000000] hover:text-white shadow-lg hover:shadow-black/30"
// // //             >
// // //               <TwitterIcon />
// // //             </motion.a>
...
// // //               href="#"
// // //               whileHover={{ scale: 1.2, y: -3 }}
// // //               className="w-8 h-8 sm:w-9 sm:h-9 bg-white/5 backdrop-blur-sm rounded-full flex items-center justify-center text-white transition-all duration-300 border border-white/10 hover:bg-[#0a66c2] hover:border-[#0a66c2] hover:text-white shadow-lg hover:shadow-[#0a66c2]/30"
// // //             >
// // //               <LinkedinIcon />
// // //             </motion.a>
...
// // //               href="#"
// // //               whileHover={{ scale: 1.2, y: -3 }}
// // //               className="w-8 h-8 sm:w-9 sm:h-9 bg-white/5 backdrop-blur-sm rounded-full flex items-center justify-center text-white transition-all duration-300 border border-white/10 hover:bg-[#ff0000] hover:border-[#ff0000] hover:text-white shadow-lg hover:shadow-[#ff0000]/30"
// // //             >
// // //               <YoutubeIcon />
// // //             </motion.a>
...
// // //               href="#"
// // //               whileHover={{ scale: 1.2, y: -3 }}
// // //               className="w-8 h-8 sm:w-9 sm:h-9 bg-white/5 backdrop-blur-sm rounded-full flex items-center justify-center text-white transition-all duration-300 border border-white/10 hover:bg-[#e4405f] hover:border-[#e4405f] hover:text-white shadow-lg hover:shadow-[#e4405f]/30"
// // //             >
// // //               <InstagramIcon />
// // //             </motion.a>
// // //           </motion.div>
...
// // //           <div className="flex flex-wrap items-center justify-center md:justify-between gap-1.5">
...
// //       {/* ===== GLOWING TOP LINE ===== */}
// //       <div className="relative z-10 h-0.5 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 shadow-lg shadow-purple-500/30"></div>
...
// //   className="lg:col-span-1"
// // >
// //   {/* ✅ Direct Logo — No Container Background */}
// //   <img 
...
// //                   <Link 
// //                     to={link.path} 
// //                     className="hover:text-[#01adf0] transition-colors duration-200"
// //                     style={{ color: '#6e6d71' }}
// //                   >
// //                     {link.name}
// //                   </Link>
...
// //                 whileHover={{ scale: 1.05 }}
// //                 whileTap={{ scale: 0.95 }}
// //                 className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white p-2 rounded-full mx-1 transition-all duration-200 shadow-lg shadow-blue-500/30"
// //               >
// //                 <Send size={16} />
// //               </motion.button>
// //             </div>
...
// //             <p className="text-xs" style={{ color: '#6e6d71' }}>
// //               © {currentYear} CoderBox. All rights reserved.
// //             </p>
            
// //             <div className="text-xs flex items-center gap-2" style={{ color: '#6e6d71' }}>
// //               <Link to="/privacy" className="hover:text-[#01adf0] transition-colors duration-200">
// //                 Privacy Policy
// //               </Link>
// //               <span style={{ color: '#c0c0c0' }}>|</span>
// //               <Link to="/terms" className="hover:text-[#01adf0] transition-colors duration-200">
// //                 Terms of Service
// //               </Link>
// //               <span style={{ color: '#c0c0c0' }}>|</span>
// //               <Link to="/cookies" className="hover:text-[#01adf0] transition-colors duration-200">
// //                 Cookie Policy
// //               </Link>
// //             </div>
// //           </div>
...
// //           >
// //             <h3 
// //               className="sec-h3 mb-4 flex items-center gap-2"
// //               style={{ color: '#1a1a1a' }}
// //             >
// //               <span className="w-5 h-0.5 bg-[#01adf0]"></span>
// //               OUR SERVICES
// //             </h3>
...
// //               className="w-9 h-9 rounded-full flex items-center justify-center transition-all duration-300 border shadow-sm hover:shadow-lg"
// //               style={{ backgroundColor: '#ffffff', borderColor: '#e5e5e5', color: '#6e6d71' }}
// //               onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#000000'; e.currentTarget.style.borderColor = '#000000'; e.currentTarget.style.color = '#ffffff'; }}
// //               onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = '#ffffff'; e.currentTarget.style.borderColor = '#e5e5e5'; e.currentTarget.style.color = '#6e6d71'; }}
// //             >
// //               <TwitterIcon />
// //             </motion.a>
...
//           transition={{ duration: 0.5 }}
//           viewport={{ once: true }}
//           src="/coderBoxlogo3.png"  // ✅ YAHAN FIX KIYA HAI (Forward slash lagaya hai)
//           alt="CoderBox Logo"
